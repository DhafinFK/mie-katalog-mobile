...
import 'package:mie_katalog_mobile/screens/indomie_detail.dart';
...
class _ProductPageState extends State<ProductPage> {
  Future<List<Indomie>> fetchProduct() async {
    var url = Uri.parse('http://127.0.0.1:8000/mie-katalog/json/');
    ...
    List<Indomie> list_product = [];
    for (var d in data) {
      if (d != null) {
        list_product.add(Indomie.fromJson(d));
      }
    }
    return list_product;
  }
